...
const EN_TO_TR: Record<string, string> = {
  ...
  'Prepare or release mode': 'Hazırlama veya serbest bırakma modu',
  'Return from SY': 'SY’den geri dönüştür',
  'Prepare balance': 'Bakiyeyi hazırla',
  'Release balance': 'Bakiyeyi serbest bırak',
  'Review prepare': 'Hazırlamayı incele',
  'Review release': 'Serbest bırakmayı incele',
  'You receive': 'Alacağınız',
  'Releasing…': 'Serbest bırakılıyor…',
  'Confirm prepare': 'Hazırlamayı onayla',
  'Confirm release': 'Serbest bırakmayı onayla',
...
const dynamicPairs: Array<[RegExp, string, RegExp, string]> = [
  ...
  [
    /^Prepares (.+) for Everspan\.$/u,
    'Everspan için $1 hazırlar.',
    /^Everspan için (.+) hazırlar\.$/u,
    'Prepares $1 for Everspan.',
  ],
  [
    /^Releases (.+) back to your wallet\.$/u,
    '$1 tutarını cüzdanınıza serbest bırakır.',
    /^(.+) tutarını cüzdanınıza serbest bırakır\.$/u,
    'Releases $1 back to your wallet.',
  ],
